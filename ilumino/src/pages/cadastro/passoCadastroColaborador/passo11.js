...
export default class Passo11 extends Component {
  ...
  nextPass = ()=> {
      ...
      Cpf = Cpf.replace('.','');
      Cpf = Cpf.replace('-','');
      if(nome.length === 0 || cpf.length === 0 || sobreNome.length === 0)
        Alert.alert('Erro - Campos vazios!');
      else
        this.props.navigation.navigate('Passo12',{data:{nome, sobreNome, cpf: Cpf, nickname}});
  }
