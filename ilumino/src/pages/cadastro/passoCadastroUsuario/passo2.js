...
import {StyleSheet, Text, ScrollView, Platform,TouchableOpacity, View, ImageBackground, Alert} from 'react-native';
...
export default class Passo2 extends Component {
  ...
  nextPass = ()=> {
    ...
    if(celular.length === 0)
      Alert.alert('Erro - celular vazio!');
    else{
      let Celular = celular;
      ...
      Celular = Celular.replace(' ','');
      Celular = Celular.replace('-','');
      this.props.navigation.navigate('Passo3',{data:{nome, sobreNome, cpf, nickname, celular:Celular , whatsapp}});
    }
}
